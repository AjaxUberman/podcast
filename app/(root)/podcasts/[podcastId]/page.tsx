...
const page = ({ params }: { params: { podcastId: Id<"podcasts"> } }) => {
  ...
  return (
    <section className="text-white-1 pb-10">
      <header className="mt-9 flex items-center justify-between">
        <h1 className="text-20 font-bold text-white-1">
          Currently Playing {podcast?.podcastTitle}
        </h1>
        <figure className="flex gap-3">
          <Image
            ...
            alt="headphone"
          />
          <h2 className="text-16 font-bold texxt-white-1">{podcast?.views}</h2>
        </figure>
      </header>
      <PodcastDetailPlayer
        isOwner={isOwner}
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-16 font-medium text-white-2">
            {podcast?.imagePrompt ? podcast?.imagePrompt : "Uploaded."}
          </p>
        </div>
      </div>
